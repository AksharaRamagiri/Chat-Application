...
//  If the form gets submitted ----when we click on "send"----send server the message.
...
// Ask the name of the new user and let the server know(let the other people know).
